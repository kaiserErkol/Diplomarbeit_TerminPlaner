...
public class Reparaturtyp {
    ...
    public boolean equals(Object o) {
        ...
        return retyp_id == that.retyp_id && dauerinmin == that.dauerinmin && Objects.equals(bezeichnung, that.bezeichnung) && Objects.equals(beschreibung, that.beschreibung) && klassifikation == that.klassifikation;
    }

    @Override
    public int hashCode() {
        return Objects.hash(retyp_id, bezeichnung, beschreibung, dauerinmin, klassifikation);
    }
}
