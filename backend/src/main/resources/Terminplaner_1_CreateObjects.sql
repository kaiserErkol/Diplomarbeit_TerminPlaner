...
CREATE SEQUENCE terminanfrage_id_seq AS INT START WITH 1 INCREMENT BY 1;
...
CREATE TABLE wartungsverlauf (
    ...
    notiz VARCHAR(250) NOT NULL DEFAULT 'Keine Notizen',
...
-- Creating the new Terminanfrage table
CREATE TABLE terminanfrage (
    terminanfrage_id INT NOT NULL DEFAULT NEXT VALUE FOR terminanfrage_id_seq,
    datum DATE NOT NULL DEFAULT GETDATE(),
    notiz VARCHAR(250),
    kunde_kunde_id INT NOT NULL,
    fahrzeug_fahrzeug_id VARCHAR(250) NOT NULL,
